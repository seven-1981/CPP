...
WAVFile::WAVFile(WAVHeader& header)
{
	...
	this->header->sample_rate = header.sample_rate;
	this->header->byte_rate = header.sample_rate * PCM_WAV_BITS * PCM_WAV_CHANNELS / 8;
...
int WAVFile::read_wav_file(std::ifstream& file)
{
	...
	this->header->file_size = file_size;
